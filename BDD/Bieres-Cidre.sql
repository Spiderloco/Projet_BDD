--DESCRIPTEUR
INSERT ALL 	
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Cidre','Le cidre est une boisson alcoolisee titrant de 2 % à 8 % 1d''alcool obtenu a partir de la fermentation du jus de pomme.'))
	...
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Sidra natural', ' Il s''agit d''un cidre de fermentation spontanée qui utilise les levures sauvages presentes sur les fruits'))
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Pomme', ' Elle est comestible et a un gout sucre ou acidule selon les varietes.'))
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Cidre traditionnel', ' Il s''agit d''un cidre de fermentation spontanee qui utilise les levures sauvages présentes sur les fruits'))
	...
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Biere', '   boisson alcoolisée obtenue par fermentation de matières glucidiques vegetales et d''eau'))
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Ale', '  bieres de fermentation haute'))
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Cervoise', '  biere faite avec de l''orge ou d''autres céréales '))
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Eau de vie', '  un produit de la distillation d’un liquide faiblement alcoolise '))
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Dolo', '  biere traditionnelle brassée essentiellement par les populations de l''Afrique sub-sahelienne'))
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Lager', '   bieres à fermentation basse'))
	...
	INTO DESCRIPTEUR VALUES (Descripteur_T ('Sake', '   boisson alcoolisee japonaise à base de riz'))
