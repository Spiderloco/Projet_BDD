...
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Drambuie'))
INTO DESCRIPTEUR VALUES (Descripteur_T ('Génépi', 'Ce nom désigne la liqueur obtenue par la macération des plantes Artemisia.'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Liqueur de genièvre'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Liqueur de gentiane'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Gold Strike'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Grand Marnier'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Guignolet'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Izarra'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Jägermeister'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Kahlua'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Kummel'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Licor 43'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Liqueur de myrte'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Millz Premium'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Noyau de Poissy'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Liqueur de sapin'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Persico'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Liqueur de Poejo'))
--INTO DESCRIPTEUR VALUES (Descripteur_T ('Rhubarbe Zucca'))
...
--INTO Descripteur VALUES (Descripteur_T ('Suze'))
--INTO Descripteur VALUES (Descripteur_T ('Thibarine'))
...
INTO DESCRIPTEUR VALUES  (Descripteur_T ('Angostura' , '(Venezuela)'))
INTO DESCRIPTEUR VALUES  (Descripteur_T ('Campari', '(Italie)'))
INTO DESCRIPTEUR VALUES  (Descripteur_T ('Fernet Branca', '(Italie)'))
INTO DESCRIPTEUR VALUES  (Descripteur_T ('China Martini', '(Italie, à base de cinchona)'))
INTO DESCRIPTEUR VALUES  (Descripteur_T ('Cynar','(Italie, à base d''artichaut)'))
INTO DESCRIPTEUR VALUES  (Descripteur_T ('Gran Classico', '(Suisse)'))
INTO DESCRIPTEUR VALUES  (Descripteur_T ('Jägermeister', '(Allemagne)'))
INTO DESCRIPTEUR VALUES  (Descripteur_T ('Orange bitters', '(Angleterre)'))
INTO DESCRIPTEUR VALUES  (Descripteur_T ('Picon', '(est et nord de la France)'))
INTO DESCRIPTEUR VALUES  (Descripteur_T ('Sommer', '(Alsace)'))
INTO DESCRIPTEUR VALUES  (Descripteur_T ('Suze', '(apéritif de gentiane français) et ses homologues : Avèze, Salers...'))
...
INTO DESCRIPTEUR_VEDETTE VALUES ('Sodabi')
...
-- ASSOCIATIONS Descripteur-DescripteurVedette
INSERT ALL
	-- Les Spiritueux
	INTO ASSOCIATION VALUES ('Amaretto' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Aquavit' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Arak' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Armagnac' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Brandy' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Calvados' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Chartreuse' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Cognac' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Curaçao', 'Spiritueux')
	INTO ASSOCIATION VALUES ('Floc de Gascogne' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Gin' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Grappa' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Kirsch' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Liqueurs' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Mei kwei lu chew' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Ouzo' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Pastis' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Pineau des Charentes' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Pontarlier' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Rakı' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Rhum' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Sambuca' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Tequila' , 'Spiritueux')
	INTO ASSOCIATION VALUES ('Sodabi' , 'Spiritueux')
	...
	INTO ASSOCIATION VALUES ('Génépi' , 'Liqueurs' )
	INTO ASSOCIATION VALUES ('Triple sec' , 'Liqueurs' )
	...
	INTO ASSOCIATION VALUES ('Old tom Gin' , 'Gin')
	INTO ASSOCIATION VALUES ('Yellow gin' , 'Gin')
	INTO ASSOCIATION VALUES ('Cork Gin' , 'Gin')
SELECT * FROM dual;
